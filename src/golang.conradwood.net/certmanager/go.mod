...
require (
	...
	golang.conradwood.net/apis/h2gproxy v1.1.2106
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2106 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.2106 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2106 // indirect
	golang.conradwood.net/apis/echoservice v1.1.2106 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.2106 // indirect
